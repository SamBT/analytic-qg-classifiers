...
bool Writer::writeEvent(HEPEUP * peup) {
  ...
  file << " " << std::setw(8) << 1
         << " " << std::setw(2) << eup.ISTUP[3]
         << " " << std::setw(4) << eup.MOTHUP[3].first
         << " " << std::setw(4) << eup.MOTHUP[3].second
         << " " << std::setw(4) << 1
         << " " << std::setw(4) << 0
         << " " << std::setw(14) << eup.PUP[3][0]
         << " " << std::setw(14) << eup.PUP[3][1]
         << " " << std::setw(14) << eup.PUP[3][2]
         << " " << std::setw(14) << eup.PUP[3][3]
         << " " << std::setw(14) << eup.PUP[3][4]
         << " " << std::setw(1) << eup.VTIMUP[3]
         << " " << std::setw(1) << eup.SPINUP[3] << std::endl;

  file << " " << std::setw(8) << -1
         << " " << std::setw(2) << eup.ISTUP[4]
         << " " << std::setw(4) << eup.MOTHUP[4].first
         << " " << std::setw(4) << eup.MOTHUP[4].second
         << " " << std::setw(4) << 0
         << " " << std::setw(4) << 1
         << " " << std::setw(14) << eup.PUP[4][0]
         << " " << std::setw(14) << eup.PUP[4][1]
         << " " << std::setw(14) << eup.PUP[4][2]
         << " " << std::setw(14) << eup.PUP[4][3]
         << " " << std::setw(14) << eup.PUP[4][4]
         << " " << std::setw(1) << eup.VTIMUP[4]
         << " " << std::setw(1) << eup.SPINUP[4] << std::endl;
